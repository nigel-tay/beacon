...
public class SightingController {
    ...
    public ResponseEntity<String> getAllSightings(@RequestParam int page, @RequestParam int pageSize) {
        Optional<List<Sighting>> sightings = sightingService.getAllSightings(page, pageSize);
